...
// CODE HERE
const divideNumbers = numbers.map((element) => element / 2)
...
const iCity = cities.filter(element => element.endsWith("i"))
// console.log(iCity)
...
fruits.forEach((element, index) => {
  if(element.color === 'red'){
    return console.log(`The fruit w/ index ${index} is an apple.`)
  }else if(element.color === 'orange'){
    return console.log(`The fruit w/ index ${index} is an orange`)
  }else{
    return console.log(`The fruit w/ index ${index} is neither apple or orange`)
  }
});
...
// The fruit w/ index 0 is neither apple or orange
// The fruit w/ index 1 is an orange
// The fruit w/ index 2 is neither apple or orange
// The fruit w/ index 3 is an apple.
...
const riceTotal =  foods.filter(element => element.tags.includes('rice')).map((element)=>element.price).reduce((acc, cur) => acc + cur)
